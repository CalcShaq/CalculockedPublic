...
const ProfileScreen = () => {
  ...
  // State for showing/hiding passwords in the profile list
  ...
  // Function to toggle password visibility for a specific profile
      ...
      <ScrollView style={styles.scrollView}>
        ...
        {showCreateForm && (
          <View style={styles.createForm}>
            ...
            />
            <View style={componentStyles.passwordContainer}>
              <TextInput
                style={[styles.input, componentStyles.passwordInput]}
              ...
              />
              <TouchableOpacity
                style={componentStyles.showHideButton}
                onPress={() => setShowPassword(!showPassword)}
              >
                <Text style={componentStyles.showHideText}>
                ...
                profiles.map(profile => (
                  ...
                  >
                    ...
                    <View style={styles.profileDetails}>
                      ...
                      <View style={componentStyles.passwordDisplayContainer}>
                        ...
                        <TouchableOpacity
                          style={componentStyles.showHideButtonSmall}
                          onPress={() => toggleProfilePasswordVisibility(profile.id)}
                        >
                          <Text style={componentStyles.showHideTextSmall}>
