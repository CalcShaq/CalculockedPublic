...
import CalculatorScreen from './screens/Calculator'; // Import the Calculator screen
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Welcome">
        ...
        <Stack.Screen name="Calculator" component={CalculatorScreen} /> {/* Register Calculator screen */}
      </Stack.Navigator>
    </NavigationContainer>
  );
}
